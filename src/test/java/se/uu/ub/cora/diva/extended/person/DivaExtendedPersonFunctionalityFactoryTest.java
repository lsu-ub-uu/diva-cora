...
// import static
/// se.uu.ub.cora.spider.extendedfunctionality.ExtendedFunctionalityPosition.CREATE_AFTER_METADATA_VALIDATION;
// import static
/// se.uu.ub.cora.spider.extendedfunctionality.ExtendedFunctionalityPosition.CREATE_BEFORE_RETURN;
// import static
/// se.uu.ub.cora.spider.extendedfunctionality.ExtendedFunctionalityPosition.DELETE_AFTER;
// import static
/// se.uu.ub.cora.spider.extendedfunctionality.ExtendedFunctionalityPosition.DELETE_BEFORE;
// import static
/// se.uu.ub.cora.spider.extendedfunctionality.ExtendedFunctionalityPosition.UPDATE_AFTER_METADATA_VALIDATION;
// import static
/// se.uu.ub.cora.spider.extendedfunctionality.ExtendedFunctionalityPosition.UPDATE_AFTER_STORE;
// import static
/// se.uu.ub.cora.spider.extendedfunctionality.ExtendedFunctionalityPosition.UPDATE_BEFORE_STORE;
//
...
// PersonDomainPartFromPersonUpdater functionality = (PersonDomainPartFromPersonUpdater)
/// functionalities
// .get(0);
...
// ClassicFedoraUpdaterFactoryImp classicFedoraUpdaterFactory = (ClassicFedoraUpdaterFactoryImp)
...
// ClassicFedoraUpdaterFactoryImp classicFedoraUpdaterFactory) {
// RepeatableRelatedLinkCollectorImp repeatableRelatedLinkCollector =
/// (RepeatableRelatedLinkCollectorImp) classicFedoraUpdaterFactory
// .getRepeatableRelatedLinkCollector();
// RelatedLinkCollectorFactoryImp relatedLinkCollectorFactory = (RelatedLinkCollectorFactoryImp)
/// repeatableRelatedLinkCollector
...
// assertEquals(functionalities.size(), 2);
//
// PersonUpdaterAfterDomainPartCreate personUpdater = (PersonUpdaterAfterDomainPartCreate)
/// functionalities
// .get(0);
//
...
// List<ExtendedFunctionality> functionalities) {
// PersonUpdaterAfterDomainPartDelete personudpaterAfterDomainPartDelete =
/// (PersonUpdaterAfterDomainPartDelete) functionalities
// .get(0);
//
...
//
// PersonDomainPartOrganisationSameDomainValidator sameDomain =
/// (PersonDomainPartOrganisationSameDomainValidator) functionalities
// .get(1);
// assertSame(sameDomain.getRecordStorageOnlyForTest(), recordStorage);
//
// CopyDataFromPersonToPersonDomainPartOnCreate copyFunctionality =
/// (CopyDataFromPersonToPersonDomainPartOnCreate) functionalities
// .get(2);
